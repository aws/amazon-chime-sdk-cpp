...
### Fixed
* Fixed 2 crashes related to failed connection logic and 1 memory leak related to reconnection logic

## [0.11.1] - 2024-10-24

### Fixed
* Fixed memory leak related to Libwebsockets context
* Fixed bug that prevented video stream metrics from being added to metric reports
* Fixed signal strength updates to also report when the signal strength is 1
