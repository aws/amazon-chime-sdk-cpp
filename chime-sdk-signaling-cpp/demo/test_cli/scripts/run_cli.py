...
parser.add_argument('-l', '--log-level', dest='log_level',
                    ...
                    default="info")
parser.add_argument('-ic', '--is-canary', action="store_true", dest='is_canary',
                    help='is it canary', default=False)
...
print("Executing test_cli...")
dir_path = os.path.dirname(os.path.abspath(__file__))

executable_name = 'test_cli'
...
cmd = [file_path, '--attendee_id', attendee_id,
